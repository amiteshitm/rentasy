      ...
      <div className="rentals-page">
        <div className="test">
          ...
          <div className="browser-catagory-see">
            ...
            <div onClick={handleSeemoreCategories} className="see-more">
              See more
            </div>
          </div>
          ...
          <div className="choice-container">
            ...
            <div className="sofa-variety-container">
              <div className="icon">
                ...
                <img
                  src={Images.ForwardcircleIcon}
                  className="forwarcircle-img"
                  alt=""
                />
              </div>
              ...
              <div className="available-renteasy">
                <div className="available-on">
                  <div className="logo-app">
                    <img
                      src={Images.RenteasylogoIcon}
                      className="renteasylogo-img"
                      alt=""
                    />
                    <div className="app-store">
                      Available on <br /> App Store and Play store
                    </div>
                  </div>
                  <button className="download">Download Now</button>
                </div>
                <img
                  src={Images.MobilerenteasyIcon}
                  className="mobile-renteasy-img"
                  alt=""
                />
              </div>
            </div>
                ...
                <div className="users-quotation-container">
                  <div className="users-quotation-content">
                    ...
                    <p>
                      ...
                      magna aliquyam erat, sed diam voluptua. At vero eos psum
